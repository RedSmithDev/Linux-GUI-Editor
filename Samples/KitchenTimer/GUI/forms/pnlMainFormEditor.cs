...
partial class pnlMainForm

    {
		...
		CheckBox chkPopUp = new CheckBox();
		CheckBox chkSound = new CheckBox();
		ComboBox cmbMinutes = new ComboBox();
		...
		memFormList.Add("Text:Main Form");
		memFormList.Add("[CheckBox]");
		memFormList.Add("Name:chkPopUp");
		memFormList.Add("Position:105,90");
		memFormList.Add("Size:116,24");
		memFormList.Add("FontName:DejaVu Sans");
		memFormList.Add("FontSize:11");
		memFormList.Add("BackColor:100,100,100");
		memFormList.Add("ForeColor:211,211,211");
		memFormList.Add("Text:Pop Up");
		memFormList.Add("FlatStyle:Flat");
		memFormList.Add("[CheckBox]");
		memFormList.Add("Name:chkSound");
		memFormList.Add("Position:10,90");
		memFormList.Add("Size:68,24");
		memFormList.Add("FontName:DejaVu Sans");
		memFormList.Add("FontSize:11");
		memFormList.Add("BackColor:100,100,100");
		memFormList.Add("ForeColor:211,211,211");
		memFormList.Add("Text:Sound");
		memFormList.Add("FlatStyle:Flat");
		memFormList.Add("[ComboBox]");
		memFormList.Add("Name:cmbMinutes");
		memFormList.Add("Position:100,10");
		memFormList.Add("Size:121,26");
		memFormList.Add("FontName:DejaVu Sans");
		memFormList.Add("FontSize:11");
		memFormList.Add("BackColor:100,100,100");
		memFormList.Add("ForeColor:211,211,211");
		memFormList.Add("Text:00:15:00");
		memFormList.Add("FlatStyle:Flat");
		memFormList.Add("[Label]");
		memFormList.Add("Name:lblElapsedTime");
		memFormList.Add("Position:100,50");
		memFormList.Add("Size:124,30");
		memFormList.Add("FontName:DejaVu Sans");
		memFormList.Add("FontSize:11");
		memFormList.Add("BackColor:100,100,100");
		memFormList.Add("ForeColor:211,211,211");
		memFormList.Add("Text:Elapsed Time");
		memFormList.Add("FlatStyle:Flat");
		memFormList.Add("TextAlign:Left");
		memFormList.Add("BorderStyle:Outlined");
		memFormList.Add("[Button]");
		memFormList.Add("Name:btnStop");
		memFormList.Add("Position:10,50");
		memFormList.Add("Size:75,30");
		memFormList.Add("FontName:DejaVu Sans");
		memFormList.Add("FontSize:11");
		memFormList.Add("BackColor:100,100,100");
		memFormList.Add("ForeColor:211,211,211");
		memFormList.Add("Text:Stop");
		memFormList.Add("FlatStyle:Flat");
		memFormList.Add("[Button]");
		memFormList.Add("Name:btnStart");
		...
		cFormManager.readControlsInMem_s(Controls, this, memFormList,false);
			...
			chkPopUp = (CheckBox)getControl(efrmMainControls.chkPopUp);
			chkSound = (CheckBox)getControl(efrmMainControls.chkSound);
			cmbMinutes = (ComboBox)getControl(efrmMainControls.cmbMinutes);
			lblElapsedTime = (Label)getControl(efrmMainControls.lblElapsedTime);
			btnStop = (Button)getControl(efrmMainControls.btnStop);
			btnStart = (Button)getControl(efrmMainControls.btnStart);
